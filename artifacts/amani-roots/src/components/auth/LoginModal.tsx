    ...
    >
      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="font-heading text-2xl font-light tracking-wide mb-3" style={{ color: "var(--text)" }}>
            Welcome Back
          </h2>
          <p className="text-xs font-light leading-relaxed" style={{ color: "var(--text-muted)" }}>
            {reason ?? "Sign in to share your story with the community."}
          </p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 py-3.5 px-6 border-2 text-sm font-light tracking-wide transition-all hover:shadow-md disabled:opacity-50"
          style={{ borderColor: "var(--lavender)", color: "var(--text)", backgroundColor: "transparent" }}
        >
        ...
        <p className="text-center text-[10px] font-light mt-5 leading-relaxed" style={{ color: "var(--text-muted)" }}>
          By signing in you agree to share your name and photo with the community.
        </p>
      </motion.div>
    </div>
  )
